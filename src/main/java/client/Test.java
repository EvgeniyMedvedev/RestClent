...
public class Test {
    ...
    private static String postLogin(String username, String password) {
        ...
        // POST Login
        ResponseEntity<String> response = restTemplate.postForEntity(URL_LOGIN, requestEntity, String.class);
    ...
    public static void main(String[] args) {
        String username = "tom";
        String password = "$2a$10$24eZq7Xe5p53icJ7fMJAq.o7XCUW6ilUhe0CADsCbJ8NhTj2NCXHG";
